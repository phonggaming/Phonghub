...
Toggle = Tabs.RC:AddToggle("MyToggle", {Title = " giết người Trial┊No Skill", Default = KillPlayer })
    Toggle:OnChanged(function(Value)
        KillPlayer = Value
